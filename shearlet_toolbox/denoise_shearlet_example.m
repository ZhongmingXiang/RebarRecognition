...
figure(6)
subplot(121)
aaa=abs(dst{2}(:,:,1)+dst{2}(:,:,4)+dst{2}(:,:,5)+dst{2}(:,:,6)+dst{2}(:,:,7)+dst{2}(:,:,8));
imagesc(aaa)
subplot(122)
bbb=abs(dst{2}(:,:,2)+dst{2}(:,:,3));
imagesc(bbb)

%J1=imadjust(aaa,[0.2 0.5],[]);
J1=histeq(aaa,256);
J2=imadjust(bbb,[0.2 0.5],[]);
figure(7)
subplot(121)
imshow(J1)
subplot(122)
